...
HEADERS = {
    ...
    'x-csrf-token': '2f7d9191cd04d1ccb4b023b23fc8c33bb4ff4b8f2c1183d7bc884544fdf8402acb16e04108f2e2aff239517afdee4058d4b96078b8321228b3b0e21f1599226b6e4f6868324d4b479d404136e4e36b70',
...
def post_tweets(file_name, delay=10):
    try:
            ...
            if tweet_text:
                ...
                if response.status_code == 200:
                    ...
                    if rest_id:
                        ...
                        print(f"Collected rest_id: {rest_id}")
                else:
...
if __name__ == "__main__":
    post_tweets(TWEET_FILE, delay=10)
